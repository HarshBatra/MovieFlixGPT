...
const VideoTitle = ({ title, overview }) => {
  return (
    <div className="text-white absolute top-10 md:top-1/3 drop-shadow-lg w-2/3 text-xs md:text-base md:w-1/3 md:pl-20 pl-10 py-10 flex flex-col md:gap-4 gap-2 z-10">
